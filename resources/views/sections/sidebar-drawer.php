...
<div class="drawer drawer-end z-[100]" id="sidebar-drawer-container">
    ...
    <div class="drawer-side">
        <label for="sidebar-drawer" aria-label="<?php echo esc_attr__('Close sidebar', 'a-ripple-song'); ?>" class="drawer-overlay"></label>
        <div class="min-h-full w-80 max-w-[90vw] bg-base-100">
            <div class="sticky top-0 z-10 flex items-center justify-between border-b border-base-300 bg-base-100 p-4">
                <h3 class="text-lg font-bold"><?php esc_html_e('Right Sidebar', 'a-ripple-song'); ?></h3>
            ...
            <div class="p-4">
                ...
                <?php else: ?>
                    <div class="rounded-lg bg-base-200 p-4 text-center text-base-content/50">
                        <p><?php esc_html_e('Please add widgets to "Sidebar" area in Appearance > Widgets in the admin panel.', 'a-ripple-song'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>

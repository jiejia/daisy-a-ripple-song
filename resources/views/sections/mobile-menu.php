  ...
  <div class="drawer-side">
    ...
    <div class="bg-base-100 h-full w-80 max-w-xs">
      <div class="sticky top-0 bg-base-100 p-4 border-b border-base-300 flex items-center justify-between">
        <h3 class="font-bold text-lg"><?php echo esc_html__('Menu', 'sage'); ?></h3>
      ...
      <ul class="menu p-4 w-full">
        ...
        $menuItems = \App\Helper::getMenuItems();
        ...
        <?php foreach ($menuItems as $menuData): ?>
          ...
          $isActive = \App\Helper::isMenuItemActive($item, $children, $currentUrl);
              ...
              <details open>
                ...
                <ul>
                  <?php foreach ($children as $childData): ?>
                    ...
                    $childIsActive = \App\Helper::isMenuItemActive($child, $grandchildren, $currentUrl);

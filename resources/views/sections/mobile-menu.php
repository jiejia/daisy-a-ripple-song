  ...
  <div class="drawer-side">
    ...
    <div class="bg-base-100 h-full w-80 max-w-xs">
      ...
      <ul class="menu p-4 w-full">
        ...
        $menuItems = \Jiejia\DaisyARippleSong\Supports\Helper::getMenuItems();
        ...
        <?php foreach ($menuItems as $menuData): ?>
          ...
          $isActive = \Jiejia\DaisyARippleSong\Supports\Helper::isMenuItemActive($item, $children, $currentUrl);
              ...
              <details open>
                ...
                <ul>
                  <?php foreach ($children as $childData): ?>
                    ...
                    $childIsActive = \Jiejia\DaisyARippleSong\Supports\Helper::isMenuItemActive($child, $grandchildren, $currentUrl);

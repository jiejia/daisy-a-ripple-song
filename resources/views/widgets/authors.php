    ...
    <?php if (empty($members) && empty($guests)): ?>
        <div class="py-8 text-center">
            <div class="text-base-content/50">
                ...
                <p class="text-sm font-medium"><?php esc_html_e('No authors yet', 'daisy-a-ripple-song'); ?></p>
                <p class="mt-1 text-xs"><?php esc_html_e('Authors will appear here after adding users', 'daisy-a-ripple-song'); ?></p>
            </div>
        </div>
    <?php endif; ?>
</div>

 ...
 */
?>
<div class="card mt-4 w-full bg-base-100">
        ...
        <?php if (empty($tags)): ?>
            <div class="py-8 text-center">
                <div class="text-base-content/50">
                    ...
                    <p class="text-sm font-medium"><?php esc_html_e('No tags yet', 'a-ripple-song'); ?></p>
                    <p class="mt-1 text-xs"><?php esc_html_e('Tags will appear here after publishing articles with tags', 'a-ripple-song'); ?></p>
                </div>
            </div>
        <?php else: ?>

...
$menu_items  = \Jiejia\DaisyARippleSong\Supports\Helper::getMenuItems();
...
<ul class="ars-primary-navigation xl:grid hidden grid-flow-col gap-2 text-md justify-center" id="menu-1">
    <?php foreach ($menu_items as $menu_data) : ?>
        ...
        $is_active    = \Jiejia\DaisyARippleSong\Supports\Helper::isMenuItemActive($item, $children, $current_url);
